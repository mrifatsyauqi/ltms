import { CardCompilerService } from '../src/services/communication/configuration/card-compiler.service.ts';
import { STARTER_PRESETS, SAMPLE_DUMMY_CONTEXT } from '../src/services/communication/configuration/template-presets.ts';
