...
export function UploadedFileCard({
  ...
  return (
    <div className="bg-white rounded-[8px] border border-slate-200 p-4 shadow-xs flex flex-col justify-between h-[230px] transition-all hover:border-slate-300">
      {/* Header */}
      ...
      {fileInfo ? (
        <div className="flex flex-col justify-between flex-1 mt-2 animate-in fade-in-50 duration-200">
          ...
          <div className="flex items-center justify-between gap-3 bg-slate-50 p-2.5 rounded-[6px] border border-slate-100">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-[6px] border border-slate-200 bg-white hover:bg-slate-50 active:scale-[0.98] text-slate-700 text-xs font-medium shadow-2xs transition-all cursor-pointer"
              >
        ...
        /* Empty / Waiting State */
        <div className="flex-1 flex flex-col items-center justify-center text-center p-4 border border-dashed border-slate-200 rounded-[6px] bg-slate-50/30 my-1">
